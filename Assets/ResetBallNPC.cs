...
public class ResetBallNPC : MonoBehaviour
{
    ...
    void Update()
    {
        float power = Random.Range(-1.1f,- 4.0f);
        float direction = Random.Range(-0.1f, 0.1f);
       ...
       else if(MoveController.throwTime == true&&hasRun == false) 
    ...
    public void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.name == "BallCheck")
        {
            ...
            MoveController.throwTime = false;   
